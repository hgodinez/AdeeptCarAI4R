...
def loop():                       #GUI
    ...
    while True:
        ...
        root.geometry('630x500')  #Main window size, middle of the English letter x.
        ...
        logo =tk.PhotoImage(file = 'logo01.png')         #Define the picture of logo,but only supports '.png' and '.gif'

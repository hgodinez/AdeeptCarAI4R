...
color_bg= '#FFFFFF' #'#E1F5FE'        #Set background color
color_text='#000000'      #Set text color
color_btn= '#FF3366' #'#212121'       #Set button color
...
def loop():                       #GUI
    ...
    while True:
        ...
        root.title('For Pleo Team Interview')      #Main window title
        root.geometry('275x500')  #Main window size, middle of the English letter x.
        ...
        logo =tk.PhotoImage(file = 'C:/Users/Humberto Godinez/adeept_picar-b/client/logo01.png')         #Define the picture of logo,but only supports '.png' and '.gif'
        ...
        BtnLED.place(x=70,y=385)

        BtnOCV = tk.Button(root, width=15, text='Find Pleo Logo',fg=color_text,bg=color_btn,relief='ridge',command=call_opencv)
        BtnOCV.place(x=70,y=350)

        BtnFL = tk.Button(root, width=15, text='Find Line',fg=color_text,bg=color_btn,relief='ridge')
        BtnFL.place(x=70,y=425)
        ...
        #can_scan.place(x=275,y=130) #Place the canvas
        ...
        #l_ip_4=tk.Label(root,width=18,text='Disconnected',fg=color_text,bg='#FFFFFF')
        #l_ip_4.place(x=490,y=80)                         #Define a Label and put it in position
        ...
        #Btn14.place(x=520,y=10)                          #Define a Button and put it in position
        ...
        Btn0.place(x=100,y=165)
        Btn1.place(x=100,y=200)
        Btn2.place(x=30,y=200)
        Btn3.place(x=170,y=200)
        Btn4.place(x=170,y=245)
        Btn5.place(x=30,y=245)
        
        #Btn6.place(x=335,y=430)
        #Btn7.place(x=475,y=430)
        #Btn8.place(x=405,y=465)
        #Btn9.place(x=405,y=395)
        #Btn10.place(x=405,y=430)
        #Btn11.place(x=520,y=50)
